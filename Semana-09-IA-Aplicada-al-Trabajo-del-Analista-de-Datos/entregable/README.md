...
- La **sugerencia** recibida.
- Tu **evaluación técnica**: ¿aceptás la mejora o no? ¿Por qué?

### Tarea 2 — Generación de insights
Pegá los resultados de las consultas de **M4** en el prompt y pedile a la IA que identifique los **3 hallazgos más importantes** para el equipo comercial. Evaluá críticamente:
- ¿Son correctos? ¿Son accionables?
- ¿Hay alguno que la IA **pasó por alto**?

### Tarea 3 — README del repositorio
Pedile a la IA que genere el `README.md` de tu repositorio GitHub describiendo el proyecto RetailPro, las herramientas usadas y cómo ejecutar los scripts SQL. **Editá** la versión generada con **al menos 3 cambios justificados** y subila a tu repositorio.

### Tarea 4 — Reflexión
Escribí un párrafo explicando **en qué momento** del proyecto la IA fue más útil y **en qué momento** tu criterio analítico fue más importante que su respuesta.
