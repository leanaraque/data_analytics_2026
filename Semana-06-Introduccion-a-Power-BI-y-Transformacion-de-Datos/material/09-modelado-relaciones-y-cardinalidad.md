...
> **¿Por qué importa?** Si diseñás un modelo asumiendo que siempre habrá pedidos por cliente `(1,N)` y luego querés analizar *"clientes que no compraron nada"*, tus cálculos podrían fallar o excluir datos importantes. La cardinalidad mínima guía el tipo de relación a usar.
...
- **Crear tablas intermedias innecesarias:** en Power BI buscamos equilibrio, no normalización extrema. Si es 1:1, a menudo conviene tener todo en una sola tabla.
- **Conectar tablas N:N directamente:** relacionar "Vendedores" con "Países" sin una **tabla puente** produce resultados duplicados en todas tus sumas y medidas DAX. Siempre usá una tabla intermedia para resolver N:N.
...
---
<p align="center">
<a href="./08-maestria-del-etl.md">Anterior</a> · <a href="../README.md">Semana 6</a> · <a href="../entregable/README.md">Ir al entregable (M6)</a>
</p>
