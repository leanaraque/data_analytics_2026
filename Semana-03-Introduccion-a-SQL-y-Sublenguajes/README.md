...
> El script debe ser **repetible**: al ejecutarlo dos veces no debe fallar (por eso empieza con `DROP TABLE IF EXISTS` en el **orden inverso** de las dependencias). Y recordá: **`DECIMAL` para dinero**, nunca `FLOAT`.
...
---
<p align="center">
<a href="../Semana-02-Modelos-y-Disenos-de-Bases-de-Datos/">Semana 2</a> · <a href="../README.md">Índice del curso</a> · <a href="../Semana-04-Sintaxis-SQL-y-Manipulacion-de-Datos/">Semana 4</a>
</p>
