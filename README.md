...
| # | Semana | Tema | Estado |
|---|--------|------|:------:|
| 1 | [Semana 1](./Semana-01-Introduccion-al-Analisis-de-Datos/) | Introducción al Análisis de Datos | ✅ |
...
1. **Clonar el repositorio:**
   ```bash
   git clone https://github.com/leanaraque/ch_data_analytics_V2.git
   ```
