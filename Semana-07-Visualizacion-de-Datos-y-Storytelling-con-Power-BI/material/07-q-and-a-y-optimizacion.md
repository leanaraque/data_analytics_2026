...
## ¿Qué es la función Q&A?
Permite hacer preguntas sobre tus datos en lenguaje natural y obtener gráficos como respuesta. Es especialmente útil para usuarios no familiarizados con la creación de gráficos o que buscan información rápido. Con los modelos de lenguaje de IA, cada vez es más precisa y cercana a un diálogo natural.

## Cómo usarla (paso a paso)
1. **Acceder:** abrí tu reporte en Power BI Desktop y hacé clic en el ícono de **Preguntas y respuestas** en el panel de visualizaciones. Aparece un cuadro de texto.
2. **Formular la pregunta** en lenguaje natural:
   - *"¿Cuáles son las ventas totales por región?"*
   - *"¿Cuál es la tendencia de ventas mensuales en 2023?"*
   - *"¿Qué productos tuvieron las mejores ventas el mes pasado?"*
3. **Revisar y ajustar:** Power BI genera un gráfico; podés reformular la pregunta para afinar el resultado.
4. **Insertar el gráfico:** confirmá para añadir la visualización al reporte.

## Buenas prácticas para preguntas efectivas
Para que Q&A funcione bien, el **modelo de datos** debe estar prolijo:
- **Nombres de campos claros** (que reflejen el lenguaje del negocio).
- **Relaciones correctamente definidas** entre tablas (M6).
- Preguntas concretas, usando los nombres reales de tus dimensiones y medidas.
