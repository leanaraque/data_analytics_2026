# Semana 7 — Visualización de Datos y Storytelling con Power BI
...
- Agregar **interactividad**: segmentadores, filtros, interacciones entre visuales y parámetros.
- Construir una **narrativa** con datos (data storytelling): de dato a *insight* a acción.
...
**¿En qué consiste, en una frase?** Antes de abrir Power BI y arrastrar gráficos, **planificás**: diseñás el **boceto (mockup)** del dashboard ejecutivo de RetailPro, decidiendo qué mostrar, dónde y por qué. Es el **plano** del dashboard que vas a construir después.

**Lo que entregás:**

| Parte | Detalle |
|-------|---------|
| 1. Propósito | Una sola frase, orientada a la acción (basada en tu pregunta diagnóstica de M1) |
| 2. Layout (patrón Z) | Zona de Oro (4 KPIs arriba), tendencia (líneas), comparación (barras), tabla de detalle abajo |
| 3. Justificación | Por qué esos KPIs, esos gráficos y cómo separás resumen de detalle |
...
└── entregable/          → consigna del Boceto del Dashboard (M7)
```
