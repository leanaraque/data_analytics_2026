...
|-------|---------------|--------------------------|
| **A. La base de datos** (extracción + transformación con SQL) | El *cimiento*: entender la arquitectura de la información y preparar datos confiables | S2, S3, S4, S5, S6 |
| **B. El análisis del "por qué"** (estadística aplicada) | La *lente*: dar sustento a las conclusiones con tendencia central, dispersión y detección de outliers | S1, S10 |
| **C. La narrativa visual** (storytelling con Power BI) | El *puente comunicativo*: traducir datos en *insights* accionables para el negocio | S7, S8, S9 |

> Si el cimiento (SQL) es débil, **todo el análisis posterior carece de validez**. La integración ocurre cuando el dashboard permite navegar por los datos que preparaste y validaste en las etapas anteriores.
...
|--------|--------------------|
| **S1 · Fundamentos** | Datos vs. información · definir la pregunta de negocio |
| **S2 · Modelado de BD** | Diseñar el modelo relacional (diagrama ER, 3NF) |
| **S3–S5 · SQL** | Crear la base, poblarla y **extraer** los datos con consultas y JOINs |
| **S6 · ETL** | **Limpiar y transformar** con Power Query |
| **S7 · Visualización** | Diseñar el **dashboard** y contar la historia |
| **S8 · DAX** | **Modelar** y calcular las medidas/KPIs |
| **S9 · IA** | Documentar y acelerar el trabajo con criterio |
| **S10 · Estadística** | **Validar** los KPIs y detectar outliers |
